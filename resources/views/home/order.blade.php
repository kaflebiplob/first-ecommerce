    ...
    <section class="HOME">
        ...
        <div class="carts">
            <table class="carttable">
                ...
                <div style="font-size: 30px;">No pending order.</div>
                @else
                <tr class="tablehead">
                    <th class="tabletitle">Product Name</th>
                    <th class="tabletitle">Product Image</th>
                    <th class="tabletitle">Product quantity</th>
                ...
                <tr class="tabledatahead">
                    <td class="tabledata">{{$order->product->title}}</td>
                    <td class="tabledata"><img src="/products/{{$order->product->image}}" alt=""></td>
                    <td class="tabledata">{{$order->quantity}}</td>
                    <td class="tabledata">{{$order->total_value}}</td>
                    <td class="tabledata">{{$order->status}}</td>
