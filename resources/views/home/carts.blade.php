        ...
        <div class="carts">
            ...
            <table class="carttable">
                ...
                <tr class="tabledatahead">
                    <td class="tabledata">{{$carts->product->title}}</td>
                    <td class="tabledata">{{$carts->product->price}}</td>
                    <td class="tabledata"><img src="/products/{{$carts->product->image}}" width="150" alt=""></td>
                    <td class="tabledata">{{$carts->quantity}}</td>
                    <td class="tabledata"><a href="{{route('deletecart',$carts->id)}}">delete</a></td>

                </tr>
                <?php
                $value += $carts->product->price * $carts->quantity;
                ?>
                @endforeach
            </table>
            ...
            <div class="price">
                ...
                <h4 class="showprice">No Delivery outside valley.</h4>
            </div>
            <div class="placeorder">
                <a href="{{url('/billing')}}"><button class="placeorderbtn">CheckOut</button></a>
            </div>
        </div>
