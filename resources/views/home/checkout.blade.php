...
<body>
    <section class="HOME">
        ...
        <div class="carts">
            ...
            <!-- @if (isset($latestOrder) && $latestOrder->product)
            <h2>Product Details</h2>
            <p>Product Name: {{ $latestOrder->product->title }}</p>
            <p>Product Price: {{ $latestOrder->product->price }}</p>
            ...
            <table class="carttable">
                ...
                <tr class="tabledatahead">
                    <td class="tabledata">{{ $product->title }}</td>
                    <td class="tabledata">Rs {{ $product->price }}</td>
                    <td class="tabledata">
                        <img src="/products/{{ $product->image }}" width="150" alt="Product Image">
                    </td>
                    <td class="tabledata">1</td> <!-- Assuming quantity is 1 for "Buy Now" -->
                </tr>
            </table>
            <div class="orderform">
                <h2> your details.</h2>
