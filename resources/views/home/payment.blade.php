...
<input type="hidden" id="paymentSessionId" value="{{ $payment_session_id }}">
    <section class="HOME">
        ...
        <div class="paymentsection">
            ...
            @endif
            <div class="payment">
                <form action="{{url('/paymentsubmit')}}" method="POST">
                    @csrf
    ...
    document.addEventListener("DOMContentLoaded", function() {
        ...
        var paymentSessionId = document.getElementById("paymentSessionId").value;
        if (!paymentSessionId) {
            console.error("Payment Session ID is missing or invalid.");
            return; 
        }
